...
;------------------------------------------------------
f=addfile(dir0+"test_${S}_001_cfcs_ideal_r192x96_dissic_18500101_21491231_lon_${A}.nc","r")
tot_flt=f->dissic(:,:,:,0) ; time x depth x lat
g=addfile(dir0+"test_${S}_001_cfcs_ideal_r192x96_dissicnat_18500101_21491231_lon_${A}.nc","r")
nat_flt=g->dissicnat(:,:,:,0)
h=addfile(dir0+"test_${S}_001_cfcs_ideal_r192x96_dissicant_18500101_21491231_lon_${A}.nc","r")
ant_flt=h->dissic(:,:,:,0)
;------------------------------------------------------
