...
plot=new(9,graphic)
 wks=gsn_open_wks("png",dir1+"Flat10_DICs_ANO_global_map_3periods_dep_${dep}")
 res                        =   True
 res@gsnFrame               =       False
 res@gsnDraw                =       False
 res@cnFillOn               =       True
 ...
 gsn_text_ndc(wks,"DIC~B~ant~N~",0.05,0.27,txres1)
 txres1@txFontHeightF = 0.014
 ...
 gsn_text_ndc(wks,"[mol/m~S~3~N~]",0.94,0.15,txres1)
