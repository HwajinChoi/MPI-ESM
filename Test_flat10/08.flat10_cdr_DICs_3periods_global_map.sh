...
f=addfile(dir0+"test_flat10_cdr_001_cfcs_ideal_r192x96_dissic_dep${dep}_18500101_21491231.nc","r")
flt_tot=f->dissic(:,0,:,:)
flt_tot_an=month_to_annual(flt_tot,1)
g=addfile(dir0+"test_flat10_cdr_001_cfcs_ideal_r192x96_dissicnat_dep${dep}_18500101_21491231.nc","r")
flt_nat=g->dissicnat(:,0,:,:)
flt_nat_an=month_to_annual(flt_nat,1)
h=addfile(dir0+"test_flat10_cdr_001_cfcs_ideal_r192x96_dissicant_dep${dep}_18500101_21491231.nc","r")
flt_ant=h->dissic(:,0,:,:)
...
plot=new(9,graphic)
 wks=gsn_open_wks("png",dir1+"Flat10_cdr_DICs_ANO_global_map_3periods_dep_${dep}")
 res                        =   True
 res@gsnFrame               =       False
 res@gsnDraw                =       False
 res@cnFillOn               =       True
