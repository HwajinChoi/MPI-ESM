...
res@gsnCenterString=""
plot(3)  = gsn_csm_contour(wks, Last_First_flt(1,:,:),res )   ; plaace holder
plot(6)  = gsn_csm_contour(wks, Last_First_flt(2,:,:), res )   ; plaace holder
res@tiYAxisString=""
res@tmYLLabelsOn	= False
res@gsnCenterString="(b) flat10-zec"
plot(1)  = gsn_csm_contour(wks, Last_First_flt_zec(0,:,:), res )   ; plaace holder
res@gsnCenterString=""
plot(4)  = gsn_csm_contour(wks, Last_First_flt_zec(1,:,:), res )   ; plaace holder
plot(7)  = gsn_csm_contour(wks, Last_First_flt_zec(2,:,:), res )   ; plaace holder
res@gsnCenterString="(c) flat10-cdr"
plot(2)  = gsn_csm_contour(wks, Last_First_flt_cdr(0,:,:), res )   ; plaace holder
res@gsnCenterString=""
plot(5)  = gsn_csm_contour(wks, Last_First_flt_cdr(1,:,:), res )   ; plaace holder
plot(8)  = gsn_csm_contour(wks, Last_First_flt_cdr(2,:,:), res )   ; plaace holder

res1@gsnCenterString=""
do j=0,2
plot2(3*j)= gsn_csm_contour(wks, diff_amoc, res1 )
plot2(3*j+1)= gsn_csm_contour(wks, zec_diff_amoc, res1 )
plot2(3*j+2)= gsn_csm_contour(wks, cdr_diff_amoc, res1 )
end do
