...
var_name(0:1)=":F21:-:F21:u:H6::V10::F18:s:F21:${a}:H-40::V-1::F21:__:H-35::V-30::F18:s:F10:x"
var_name(2:3)=":F21:-:F21:v:H6::V10::F18:s:F21:${a}:H-40::V-1::F21:__:H-35::V-30::F18:s:F10:y"
var_name(4:5)=":F21:-:F21:w:H6::V10::F18:s:F21:${a}:H-40::V-1::F21:__:H-35::V-30::F18:s:F10:z"
var_name(6)=":H6::V10::F18:s:F21:${a}:H-40::V-1::F21:__:H-35::V-30::F18:s:F10:t"
var_name(7)="Residual"

do n = 0,3
plot=new(4,graphic)
plot1=new(4,graphic)
wks=gsn_open_wks("png","${dir2}/Map_${v}_budget_advections_COBALT_lead_correlation_"+n)
res                        =   True
res@gsnFrame               =       False
res@gsnDraw                =       False
res@cnFillOn               =       True
...
pres@gsnPanelMainString     = "Corr_map_${v}_budget_COBALT_LTs"
