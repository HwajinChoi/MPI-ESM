...
dir2=/data/hjchoi/CMI/OBA/data/advection/new
...
for var in "dt" "dx" "dy" "dz"; do 
#for v in "dz"; do 
 for dep in "0-100" "100-300" "300-800"; do 
   v=${var}_${dep}
 if [ $v = "dt_0-100" ] || [ $v = "dt_100-300" ] || [ $v = "dt_300-800" ]; then
 A=${dir2}/ECDA-COBALT_dO_${v}m_advection_199001-201712.nc
 C="Ot_prime=g->Ot_prime(12:335,:,:) ;time*lat*lon (monthly)"
 F="Ot_prime"
 H="dO*/dt"
 HHH="dO*_dt"
 AAA="res@cnMaxLevelValF         =     50" 
 BBB="res@cnMinLevelValF         =     -50"
 CCC="res@cnLevelSpacingF        =   5" 
 elif [ $v = "dx_0-100" ] || [ $v = "dx_100-300" ] ||[ $v = "dx_300-800" ]; then
 A=${dir2}/ECDA-COBALT_dO_${v}m_advection_199001-201712.nc
 C="u_bar_O_prime=g->u_bar_O_prime(12:335,:,:) ;time*lat*lon (monthly)"
 F="u_bar_O_prime"
 H="Ubar dO*/dx"
 HHH="Ubar_dO*_dx"
 AAA="res@cnMaxLevelValF         =     50" 
 ...
 A=${dir2}/ECDA-COBALT_dO_${v}m_advection_199001-201712.nc
 C="v_bar_O_prime=g->v_bar_O_prime(12:335,:,:) ;time*lat*lon (monthly)"
 F="v_bar_O_prime"
 H="Vbar dO*/dy"
 HHH="Vbar_dO*_dy"
 AAA="res@cnMaxLevelValF         =     50" 
 ...
 A=${dir2}/ECDA-COBALT_dO_${v}m_advection_199001-201712.nc
 C="w_bar_O_prime=g->w_bar_O_prime(12:335,:,:) ;time*lat*lon (monthly)"
 F="w_bar_O_prime"
 H="Wbar dO*/dz"
 HHH="Wbar_dO*_dz"
 AAA="res@cnMaxLevelValF         =     50" 
...
;----------------------------------------------------------------------------
 plot=new(7,graphic)
 plot1=new(7,graphic)
 wks=gsn_open_wks("x11","${dir4}/spilt_${HHH}_${r}_CMI_${e}_100-300m_and_pattern_reg_${v}_1991-2017")
 res                        =   True
 res@gsnFrame               =       False
 res@gsnDraw                =       False
 res@cnFillOn               =       True
...
;---------------------------------------------------------------------------
 ...
 plot1(0)=ShadeGtContour(plot1(0),2,12)
 ...
 plot1(1)=ShadeGtContour(plot1(1),2,12)
 ...
 plot1(2)=ShadeGtContour(plot1(2),2,12)
 ...
 plot1(3)=ShadeGtContour(plot1(3),2,12)
 ...
 plot1(4)=ShadeGtContour(plot1(4),2,12)
 ...
 plot1(5)=ShadeGtContour(plot1(5),2,12)
 ...
 plot1(6)=ShadeGtContour(plot1(6),2,12)
 ;plot1(6)=ShadeGtContour(plot1(6),2,17);pattern dots
 ...
 pres@gsnPanelMainString = "${r}_Meta|${e}|_"+depth(1)+"_regression (${H}_${dep}m)"
