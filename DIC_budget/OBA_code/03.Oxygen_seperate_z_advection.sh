...
# for d in "0-100" "100-300" "300-800";do
 ...
 a="z"
 A="ECDA-COBALT_dO_d${a}_all_depth_advection_199001-201712.nc"
 fi
...
plot=new(2,graphic)
 ...
 res@cnMaxLevelValF         =      0.00000001 
 res@cnMinLevelValF         =      -0.00000001
 res@cnLevelSpacingF        =       0.000000002
 ...
 eqn = ":F21:-:F21:${v}:H6::V10::F18:s:F21:O:B:2:N::H-40::V-1::F21:__:H-35::V-30::F18:s:F10:${a}";
  ...
  gsn_text_ndc(wks,":F18:-",.53,.510,txres)
  gsn_text_ndc(wks,":F18:'",.548,.928,txres)
  gsn_text_ndc(wks,":F18:'",.508,.49,txres)
    frame(wks)
   end
