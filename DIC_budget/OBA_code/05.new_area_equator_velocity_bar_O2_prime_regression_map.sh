...
#for v in "dt_100-300" "dx_100-300" "dy_100-300" "dz"; do 
for v in "dz"; do 
#for v in "temp_100-300m" ; do 
 ...
 C="w_bar_O_prime=g->w_bar_O_prime(12:335,:,:,1) ;time*lat*lon (monthly)"
 F="w_bar_O_prime"
 H="Wbar dO*/dz"
 HHH="Wbar_dO*_dz"
 AAA="res@cnMaxLevelValF         =     1" 
 BBB="res@cnMinLevelValF         =     -1"
 CCC="res@cnLevelSpacingF        =   0.2" 
 fi
...
;----------------------------------------------------------------------------
 plot=new(7,graphic)
 plot1=new(7,graphic)
 wks=gsn_open_wks("x11","${dir4}/${HHH}_${r}_CMI_${e}_100-300m_and_pattern_reg_${v}_1991-2017")
 res                        =   True
 res@gsnFrame               =       False
 res@gsnDraw                =       False
 res@cnFillOn               =       True
