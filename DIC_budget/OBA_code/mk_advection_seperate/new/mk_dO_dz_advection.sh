...
for n in $(seq 0 1 33) ;do 
 ...
 if [ $n = 0 ] ; then
    ncl ./mk_dO_dz_advection_surface_layer.ncl
 elif [ $n = 49 ] ; then
    ncl ./mk_dO_dz_advection_bottom_layer.ncl
 else
 cat <<EOF > ./mk_dO_dz_advection_middle_layer.ncl
begin
...
f1=addfile("${dir2}/o2_"+N(${n}-1)+"m_COBALT.199001-201712.nc","r")
f2=addfile("${dir2}/o2_"+N(${n}+1)+"m_COBALT.199001-201712.nc","r")
o2_1=f1->o2(:,0,:,:) ;time*yt_ocean*xt_ocean
o2_2=f2->o2(:,0,:,:) ;time*yt_ocean*xt_ocean
...
system("rm -f ${dir3}/ECDA-COBALT_dO_dz_"+N(${n})+"m_advection_199001-201712.nc")
out=addfile( "${dir3}/ECDA-COBALT_dO_dz_"+N(${n})+"m_advection_199001-201712.nc","c")
...
EOF
 ...
 ncl   ./mk_dO_dz_advection_middle_layer.ncl
 rm -f ./mk_dO_dz_advection_middle_layer.ncl
 fi
done
