...
;-----------------------------------------------------------------------------------------
h=addfile("${dir2}/v_"+N(${n})+"m_COBALT.199001-201712.nc","r")
v=h->v(:,0,:,:)
;-----------------------------------------------------------------------------------------
...
system("rm -f ${dir3}/ECDA-COBALT_dO_dy_"+N(${n})+"m_advection_199001-201712.nc")
out=addfile( "${dir3}/ECDA-COBALT_dO_dy_"+N(${n})+"m_advection_199001-201712.nc","c")
