...
;-----------------------------------------------------------------------------------------
g=addfile("${dir2}/u_"+N(${n})+"m_COBALT.199001-201712.nc","r")
u=g->u(:,0,:,:)
;-----------------------------------------------------------------------------------------
...
system("rm -f ${dir3}/ECDA-COBALT_dT_dx_"+N(${n})+"m_advection_199001-201712.nc")
out=addfile( "${dir3}/ECDA-COBALT_dT_dx_"+N(${n})+"m_advection_199001-201712.nc","c")
