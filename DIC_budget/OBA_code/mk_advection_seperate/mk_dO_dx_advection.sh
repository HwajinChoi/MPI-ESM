...
copy_VarCoords(O,u_prime_O_bar)
    printVarSummary(u_bar_O_prime)
    exit

system("rm -f "+dir2+"ECDA-COBALT_dO_dx_${i}_advection_199001-201712.nc")
out=addfile(    dir2+"ECDA-COBALT_dO_dx_${i}_advection_199001-201712.nc","c")
