...
plot=new(2,graphic)
 ...
 res@cnMaxLevelValF         =      0.0000005 
 res@cnMinLevelValF         =      -0.0000005
 res@cnLevelSpacingF        =       0.0000001
 ...
 eqn = ":F21:-:F21:${v}:H6::V10::F18:s:F21:O:B:2:N::H-40::V-1::F21:__:H-35::V-30::F18:s:F10:${a}";
  ...
  gsn_text_ndc(wks,":F18:-",.488,.915,txres)
  gsn_text_ndc(wks,":F18:-",.528,.512,txres)
  gsn_text_ndc(wks,":F18:'",.546,.928,txres)
  gsn_text_ndc(wks,":F18:'",.505,.50,txres)
    frame(wks)
   end
